...
MODEL                := jc_6
MODULES              := jc_6_data.c jc_6_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := jc_6.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := jc_6_ref.rsp
...
# additional includes
REQ_INCLUDES += ;E:/work/me-clab2/Lab06jj;E:/work/me-clab2/Lab06jj/jc_6_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src

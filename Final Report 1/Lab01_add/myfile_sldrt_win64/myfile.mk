...
MODEL                := myfile
MODULES              := myfile_data.c myfile_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := myfile.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := myfile_ref.rsp
...
# additional includes
REQ_INCLUDES += ;E:/work/me-clab2/Lab01_add;E:/work/me-clab2/Lab01_add/myfile_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src

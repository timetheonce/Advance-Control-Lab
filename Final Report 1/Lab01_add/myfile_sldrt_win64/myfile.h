...
#ifndef RTW_HEADER_myfile_h_
#define RTW_HEADER_myfile_h_
#include <string.h>
#ifndef myfile_COMMON_INCLUDES_
# define myfile_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* myfile_COMMON_INCLUDES_ */

#include "myfile_types.h"
...
#define myfile_rtModel                 RT_MODEL_myfile_T
...
#define rtB                            myfile_B
#define BlockIO                        B_myfile_T
#define rtX                            myfile_X
#define ContinuousStates               X_myfile_T
#define rtXdot                         myfile_XDot
#define StateDerivatives               XDot_myfile_T
#define tXdis                          myfile_XDis
#define StateDisabled                  XDis_myfile_T
#define rtP                            myfile_P
#define Parameters                     P_myfile_T
#define rtDWork                        myfile_DW
#define D_Work                         DW_myfile_T
...
struct P_myfile_T_ {
  ...
  real_T Constant_Value;               /* Expression: 0
                                        ...
                                        */
  real_T Arm_Gain;                     /* Expression: 360/(4.5*4*500)
                                        * Referenced by: '<Root>/Arm'
                                        */
  real_T pendulum_Gain;                /* Expression: 360/2000
                                        * Referenced by: '<Root>/pendulum'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_myfile_T {
  const char_T *path;
...
extern P_myfile_T myfile_P;

/* Block signals (default storage) */
extern B_myfile_T myfile_B;

/* Continuous states (default storage) */
extern X_myfile_T myfile_X;

/* Block states (default storage) */
extern DW_myfile_T myfile_DW;

/* Model entry point functions */
extern void myfile_initialize(void);
extern void myfile_output(void);
extern void myfile_update(void);
extern void myfile_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern myfile_rtModel *myfile(void);
...
extern RT_MODEL_myfile_T *const myfile_M;

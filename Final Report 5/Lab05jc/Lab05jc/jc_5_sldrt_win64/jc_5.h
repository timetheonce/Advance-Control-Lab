...
#ifndef RTW_HEADER_jc_5_h_
#define RTW_HEADER_jc_5_h_
#include <math.h>
#include <string.h>
#ifndef jc_5_COMMON_INCLUDES_
# define jc_5_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* jc_5_COMMON_INCLUDES_ */

#include "jc_5_types.h"
...
typedef struct {
  real_T Internal_CSTATE[2];           /* '<S2>/Internal' */
  real_T TransferFcn_CSTATE[2];        /* '<Root>/Transfer Fcn' */
  real_T Internal_CSTATE_n[2];         /* '<S1>/Internal' */
} X_jc_5_T;
...
/* State disabled  */
typedef struct {
  boolean_T Internal_CSTATE[2];        /* '<S2>/Internal' */
  boolean_T TransferFcn_CSTATE[2];     /* '<Root>/Transfer Fcn' */
  boolean_T Internal_CSTATE_n[2];      /* '<S1>/Internal' */
} XDis_jc_5_T;
...
#define rtB                            jc_5_B
#define BlockIO                        B_jc_5_T
#define rtX                            jc_5_X
#define ContinuousStates               X_jc_5_T
#define rtXdot                         jc_5_XDot
#define StateDerivatives               XDot_jc_5_T
#define tXdis                          jc_5_XDis
#define StateDisabled                  XDis_jc_5_T
#define rtP                            jc_5_P
#define Parameters                     P_jc_5_T
#define rtDWork                        jc_5_DW
#define D_Work                         DW_jc_5_T
...
struct P_jc_5_T_ {
  ...
  real_T Gain_Gain;                    /* Expression: 360/9000
                                        ...
                                        */
  real_T safety_Gain;                  /* Expression: 0
                                        * Referenced by: '<Root>/safety'
                                        */
  real_T Constant1_Value;              /* Expression: 90
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Internal_A_p[2];              /* Computed Parameter: Internal_A_p
...
extern P_jc_5_T jc_5_P;

/* Block signals (default storage) */
extern B_jc_5_T jc_5_B;

/* Continuous states (default storage) */
extern X_jc_5_T jc_5_X;

/* Block states (default storage) */
extern DW_jc_5_T jc_5_DW;

/* Model entry point functions */
extern void jc_5_initialize(void);
extern void jc_5_output(void);
extern void jc_5_update(void);
extern void jc_5_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern jc_5_rtModel *jc_5(void);
...
extern RT_MODEL_jc_5_T *const jc_5_M;
 ...
 * '<S1>'   : 'jc_5/LTI System'
 * '<S2>'   : 'jc_5/LTI System1'
 * '<S3>'   : 'jc_5/LTI System/IO Delay'
 * '<S4>'   : 'jc_5/LTI System/Input Delay'
 * '<S5>'   : 'jc_5/LTI System/Output Delay'
 * '<S6>'   : 'jc_5/LTI System1/IO Delay'
 * '<S7>'   : 'jc_5/LTI System1/Input Delay'
 * '<S8>'   : 'jc_5/LTI System1/Output Delay'
 */
#endif                                 /* RTW_HEADER_jc_5_h_ */

...
MODEL                := jc_5
MODULES              := jc_5_data.c jc_5_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := jc_5.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := jc_5_ref.rsp
...
# additional includes
REQ_INCLUDES += ;E:/work/me-clab2/Lab05jc;E:/work/me-clab2/Lab05jc/jc_5_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
